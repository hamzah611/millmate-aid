  ...
  const { data: notifications } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data: invoices } = await supabase
        .from("invoices")
        .select("id, invoice_number, invoice_date, invoice_type, payment_status, .select("id, invoice_number, invoice_date, invoice_type, payment_status, contacts!invoices_contact_id_fkey(payment_terms)")")
